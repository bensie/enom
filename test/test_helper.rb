...
class Test::Unit::TestCase
  ...
  commands = [
    ...
    },
    {
	  ...
	  #            https://reseller.enom.com/interface.asp?Command=SetHosts&SLD=test123456test123456&TLD=com&Address1=123.123.123.123&HostName1=test123456test123456.com&RecordType1=A&UID=resellid&PW=resellpw&ResponseType=xml
      :response => <<-EOF      
        <?xml version="1.0" ?> 
        <interface-response>
      ...
      :request => "https://reseller.enom.com/interface.asp?Command=SetHosts&SLD=test123456test123456&TLD=com&Address1=123.123.123.123&HostName1=test123456test123456.com&RecordType1=A&Address2=123.123.123.123&HostName2=www.test123456test123456.com&RecordType2=CNAME&UID=resellid&PW=resellpw&ResponseType=xml",
      :response => <<-EOF      
        <?xml version="1.0" ?> 
        <interface-response>
          <DomainRRP>E</DomainRRP> 
